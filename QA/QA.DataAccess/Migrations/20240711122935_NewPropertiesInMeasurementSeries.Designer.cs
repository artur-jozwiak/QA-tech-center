...
namespace QA.DataAccess.Migrations
{
    ...
    [Migration("20240711122935_NewPropertiesInMeasurementSeries")]
    partial class NewPropertiesInMeasurementSeries
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QA.Domain.Models.MeasurementsSeries", b =>
                {
                    ...
                    b.Property<string>("SampleLocalization")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("QA.Domain.Models.Operation", b =>
                {
                    ...
                    b.Property<int>("OperationDetailsId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QA.Domain.Models.OperationDetails", b =>
                {
                    b.HasOne("QA.Domain.Models.Operation", "Operation")
                        .WithOne("OperationDetails")
                        .HasForeignKey("QA.Domain.Models.OperationDetails", "OperationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
